  ...
  return (
    <div style={{ background: 'var(--color-canvas)', minHeight: '100vh' }}>
      ...
      <section style={{ padding: '72px 48px 80px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', textAlign: 'center' }}>
          <div style={{ maxWidth: 800, margin: '0 auto' }}>
            ...
            <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 56, fontWeight: 500, color: 'var(--color-ink)', lineHeight: 1.08, marginBottom: 24 }}>
      ...
      <section style={{ padding: '0 48px 96px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2,1fr)', gap: 24 }}>
            {items.map((t) => (
              <div key={t.name} className="hover-card-subtle" style={{ background: 'var(--color-surface-soft)', borderRadius: 'var(--rounded-md)', padding: '40px', border: '1px solid var(--color-hairline)', height: '100%', position: 'relative', overflow: 'hidden' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 24 }}>
                  <div style={{ width: 48, height: 48, borderRadius: '50%', background: t.col, opacity: 0.8, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <div style={{ width: 16, height: 16, borderRadius: '50%', background: 'var(--color-canvas)' }} />
                  </div>
                  <div>
                    <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 24, fontWeight: 500, color: 'var(--color-ink)', marginBottom: 4 }}>{t.name}</h2>
      ...
      <section style={{ background: 'var(--color-canvas)', padding: '96px 48px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div style={{ borderRadius: 'var(--rounded-lg)', background: 'var(--color-primary)', padding: '56px 64px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', position: 'relative', overflow: 'hidden' }}>
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
              ...
              <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 36, fontWeight: 500, color: 'var(--color-on-primary)', lineHeight: 1.2, marginBottom: 12 }}>¿Cuál herramienta necesitas?</h2>
