      ...
      <section className="cta-section" style={{ background: 'var(--color-surface-soft)' }}>
        <div style={{ maxWidth: 700, margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap' }}>
            <a href="https://wa.me/573000000000" target="_blank" rel="noreferrer" style={{ fontFamily: 'var(--font-body)', fontSize: 16, fontWeight: 500, color: '#fff', padding: '14px 28px', borderRadius: 'var(--rounded-lg)', background: '#25D366', display: 'inline-flex', alignItems: 'center', gap: 8, textDecoration: 'none' }}>
